...
IT_JDBC_URL="jdbc:mysql://${HOST_IP}:${HOST_PORT}/datadict?useUnicode=true&characterEncoding=UTF-8&useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC&sessionVariables=sql_mode=''&emptyStringsConvertToZero=false&jdbcCompliantTruncation=false"
