<%@ page import="eionet.meta.filters.EionetCASFilter" %>
		...
		<link rel="stylesheet" type="text/css" href="layout-screen.css" media="screen" title="Default" />
		...
		<link rel="alternate stylesheet" type="text/css" href="eea2006.css" media="screen" title="EEA 2006 style" />
