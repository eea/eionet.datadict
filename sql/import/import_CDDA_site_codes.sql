...
UPDATE T_SITE_CODE s, TMP_CDDA_SITE_CODE_IMPORT t, T_VOCABULARY_CONCEPT c SET s.YEARS_DELETED=t.SITE_DELETED_YEAR, s.YEARS_DISAPPEARED=t.SITE_DISAPPEARED_YEAR WHERE t.SITE_CODE=c.IDENTIFIER AND s.VOCABULARY_CONCEPT_ID=c.VOCABULARY_CONCEPT_ID;
