                ...
                <tr>
                    ...
                    for (int t=0; t<attrFields.size(); t++){
                        ...
                        String f_id = (String)hash.get("id");
                            %>
                            <th align="left" style="padding-right:10">&nbsp;<%=Util.processForDisplay(name)%>
                        ...
                        <tr <%=trStyle%>>
                            ...
                            for (int t=0; t<attrFields.size(); t++){
                                ...
                                <td style="padding-right:10">&nbsp;
                                    ...
                                    if (t==0){
                                        %>
                                        <a href="javascript:selectComplex(<%=j%>)"><%=Util.processForDisplay(fieldValue, true)%></a><%
                                    }
                                    else{ %>
                                        <%=Util.processForDisplay(fieldValue)%><%
                                    }
                                    %>
