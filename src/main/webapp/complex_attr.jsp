...
<h1 style="margin-bottom:20px">Complex attribute <a href=""><%=attrName%></a> of <%=dispParentType%> <a href="<%=parentLink%>"><%=dispParentName%></a></h1>
    ...
    <table class="datatable" cellspacing="0" cellpadding="0">
        ...
        for (int t=0; attrFields!=null && t<attrFields.size(); t++){
            ...
            %>
            <tr>
                <th style="padding:0;text-align:right"><%=Util.processForDisplay(name)%>:&nbsp;</th>
                <td style="padding:0">
        ...
        <tr>
            ...
            for (int t=0; attrFields!=null && t<attrFields.size(); t++){
                ...
                String name = (String)hash.get("name");
                    ...
                    %>
                    <th class="small" align="left" style="<%=style%>"><%=Util.processForDisplay(name)%></th>
                    <%
            }
            %>
        </tr>
                ...
                for (int j=0; inheritRows!=null && j<inheritRows.size(); j++){
                    ...
                    for (int t=0; t<attrFields.size(); t++){
                        ...
                        if (fieldValue == null) fieldValue = " ";
                            ...
                            %>
                            <td style="<%=tdStyle%>"><%=Util.processForDisplay(fieldValue)%></td>
                            <%
                    }
                    displayed++;
...
<div style="display:none">
    ...
    <input type="hidden" name="requester_qrystr" value="<%=Util.processForDisplay(qryStr, true, true)%>" />
    <input type="hidden" name="requester_redir_url" value="<%=Util.processForDisplay(redirUrl, true, true)%>" />
