...
<stripes:layout-render name="/pages/common/template.jsp" pageTitle="Documentation" currentSection="documentation">
    <stripes:layout-component name="contents">
        <c:set var="menuSection" value="documentation" scope="request" />
            <c:if test='${ddfn:userHasPermission(actionBean.user, "/documentation", "u")}'>
    			<div id="tabbedmenu">
	                <ul>
	                	<c:choose>
			...
			<c:choose>
           		<c:when test='${actionBean.event == "edit" && ddfn:userHasPermission(actionBean.user, "/documentation", "u")}'>
           		...
           		<c:when test='${actionBean.event == "add" && ddfn:userHasPermission(actionBean.user, "/documentation", "u")}'>
		            <stripes:form action="/documentation" method="post">
		                <table cellpadding="3">
		                    <tr>
		                        <td><stripes:label class="question" for="page_id">Page ID</stripes:label></td>
           		...
           		<c:when test='${actionBean.pageId == "contents" && ddfn:userHasPermission(actionBean.user, "/documentation", "u")}'>
