...
<stripes:layout-render name="/pages/common/template.jsp" pageTitle="Attribute editor" currentSection="administration">

    <stripes:layout-component name="contents">
        <h1>Deleting attribute 
            <stripes:link beanclass="eionet.web.action.AttributeActionBean" event="view">
        ...
        <br>
        <div>
            <stripes:form beanclass="eionet.web.action.AttributeActionBean">
