        ...
        <table cellspacing="0" class="datatable" style="width:auto">
            <tr>                
                ...
                <td>
                    <%
                    if(!mode.equals("add")){ %>
                        <em><%=Util.processForDisplay(value)%></em>
                        <input type="hidden" name="fxv_value" value="<%=Util.processForDisplay(value, true)%>"/><%
                    }
                    else{ %>
            ...
            <tr>
                ...
                <td>
                    <%
                    if (mode.equals("view")){ %>
                        <%=Util.processForDisplay(fxv.getDefinition(), true, true)%><%
                    }
                    else{ %>
                        <textarea class="small" rows="3" cols="60" name="definition"><%=Util.processForDisplay(fxv.getDefinition(), true, true)%></textarea><%
                    }
                    %>
                </td>
            </tr>            
            <tr>
                ...
                <td>
                    <%
                    if (mode.equals("view")){ %>
                        <%=Util.processForDisplay(fxv.getShortDesc(), true, true)%><%
                    }
                    else{ %>
                        <textarea class="small" rows="3" cols="60" name="short_desc"><%=Util.processForDisplay(fxv.getShortDesc(), true, true)%></textarea><%
                    }
                    %>
                </td>
            </tr>        
