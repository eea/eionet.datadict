                                                ...
                                                <table id="outputsmenu">
                                                    ...
                                                    %>
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            <td>
                                                                Create an MS Excel template for this dataset with drop-down boxes (BETA)&nbsp;<a href="<%=request.getContextPath()%>/help.jsp?screen=dataset&amp;area=excel" onclick="pop(this.href);return false;"><img style="border:0" src="<%=request.getContextPath()%>/images/info_icon.gif" width="16" height="16" alt="Help"/></a>
                                                            </td>
                                                            <td>
