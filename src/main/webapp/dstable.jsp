                                            ...
                                            <td class="simple_attr_value">
                                                <c:choose>
                                                    <c:when test="${mode eq 'view'}">
                                                        <c:if test="${not empty dsTable.rdfTypeName}">
                                                            ${dsTable.rdfTypePrefix}:${dsTable.rdfTypeName}
                                                        </c:if>
                                                    </c:when>
                                                    <c:otherwise>
                                                        <c:if test="${not empty rdfNamespaces}">
                                                            <select name="rdfNamespaceId" class="small">
                                                                ...
                                                                <c:forEach items="${rdfNamespaces}" var="rdfNamespace">
                                                                    <c:choose>
                                                                        <c:when test="${rdfNamespace.id == dsTable.rdfNamespaceId}">
                                                            ...
                                                            <br />
                                                            <input type="text" name="rdfTypeName" value="${dsTable.rdfTypeName}" />
                                                        </c:if>
                                                    </c:otherwise>
                                                </c:choose>
                                            </td>
