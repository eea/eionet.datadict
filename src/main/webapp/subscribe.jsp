                            ...
                            if (datasets==null || datasets.size()==0){
                                ...
                                <select name="dataset" id="dataset">
                                    ...
                                    for (int i=0; i<datasets.size(); i++){
                                        Dataset dst = (Dataset)datasets.get(i);
                                        %>
                                        <option value="<%=dst.getIdentifier()%>"><%=Util.processForDisplay(dst.getShortName())%></option>
                                        <%
                                    }
                                    %>
                                </select>
                                ...
                                <select name="table" id="table">
                                    ...
                                    for (int i=0; i<tables.size(); i++){
                                        ...
                                        if (dstIdf!=null && dstIdf.length()>0)
                                            value = dstIdf + "/" + value;
                                        %>
                                        <option value="<%=value%>"><%=Util.processForDisplay(text)%></option>
                                        <%
                                    }
                                    %>
                                </select>
                            ...
                            if (commonElms==null || commonElms.size()==0){
                                ...
                                <select name="common_element" id="common_element">
                                    ...
                                    for (int i=0; i<commonElms.size(); i++){
                                        DataElement elm = (DataElement)commonElms.get(i);
                                        %>
                                        <option value="<%=elm.getIdentifier()%>"><%=Util.processForDisplay(elm.getShortName())%></option>
                                        <%
                                    }
                                    %>
                                </select>
