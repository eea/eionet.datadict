...
public interface IVocabularyService {
     ...
     * @param preserveRelations shows if to replace relation IDs with baseURi/concept in the related vocabularies
     * @throws ServiceException if operation fails
     */
     ...
     *
     * @param relationalElement special relational element
