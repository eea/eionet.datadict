...
public interface AclOperationsService {
    ...
    Hashtable<String, Vector<String>> getRefreshedGroupsAndUsersHashTable() throws AclLibraryAccessControllerModifiedException, AclPropertiesInitializationException;
}