...
public class DataTableController {
    ...
    @ResponseBody
    public void getDataTableSchema(@RequestParam(value = "id") String id ,HttpServletRequest request,HttpServletResponse response ) throws ResourceNotFoundException, ServletException {
