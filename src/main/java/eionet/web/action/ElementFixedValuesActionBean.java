...
public class ElementFixedValuesActionBean extends AbstractActionBean {
    ...
    private Resolution onOwnerDataElementNotFound() {
        this.addGlobalValidationError("Cannot find element with id: " + this.ownerId);
    ...
    private Resolution onOwnerDataElementNotEditable() {
        ...
        super.addGlobalValidationError(msg);
        
        return new ForwardResolution(ERROR_PAGE);
    }
    
    private Resolution onUnauthorizedUser() {
        super.addGlobalValidationError("You are not authorized to edit this data element");
