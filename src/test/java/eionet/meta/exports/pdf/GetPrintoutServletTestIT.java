 ...
 * @author enver
 */
public class GetPrintoutServletTestIT extends DDDatabaseTestCase {
    ...
    private void initializeForStep() throws Exception {
        ...
        EasyMock.expect(requestMock.getHeader("User-Agent")).andReturn(GetPrintoutServletTestIT.USER_AGENT);
        servletContextMock.log("User-Agent= " + GetPrintoutServletTestIT.USER_AGENT);
    ...
    public void testIfPdfReturnedForADataset() throws Exception {
        ...
        EasyMock.expect(requestMock.getRequestedSessionId()).andReturn(GetPrintoutServletTestIT.REQUESTED_SESSION_ID);
