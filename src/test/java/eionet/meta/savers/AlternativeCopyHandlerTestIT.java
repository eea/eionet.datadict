 ...
 *
 */
public class AlternativeCopyHandlerTestIT extends DDDatabaseTestCase {
    ...
    /** */
    private static final Logger LOGGER = LoggerFactory.getLogger(AlternativeCopyHandlerTestIT.class);
