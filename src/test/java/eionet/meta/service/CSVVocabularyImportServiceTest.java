...
public class CSVVocabularyImportServiceTest extends UnitilsJUnit4 {
    ...
    @SpringBeanByType
    private ICSVVocabularyImportService vocabularyService;
    ...
    public void testStep1() throws Exception {
        InputStream csvInputStream = getClass().getClassLoader().getResourceAsStream("theme_env_test.csv");
        InputStreamReader reader = new InputStreamReader(csvInputStream);

        //vocabularyService.importCsvIntoVocabulary(reader, null);
