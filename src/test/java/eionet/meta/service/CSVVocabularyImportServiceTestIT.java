 ...
 * @author enver
 */
public class CSVVocabularyImportServiceTestIT extends VocabularyImportServiceTestBase {
    /**
     * Vocabulary folder CSV import service.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(CSVVocabularyImportServiceTestIT.class);
