...
public class VocabularyServiceRelationsTestIT extends UnitilsJUnit4 {

    protected static final Logger LOGGER = LoggerFactory.getLogger(VocabularyServiceRelationsTestIT.class);
