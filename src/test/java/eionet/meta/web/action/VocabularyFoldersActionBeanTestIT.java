 ...
 * @author enver
 */
public class VocabularyFoldersActionBeanTestIT extends DDDatabaseTestCase {
    ...
    private static MockServletContext getServletContextWithProperyBinder() {
        if (VocabularyFoldersActionBeanTestIT.ctxWithProperyBinder == null) {
            ...
            VocabularyFoldersActionBeanTestIT.ctxWithProperyBinder = ctx;
        }
        
        return VocabularyFoldersActionBeanTestIT.ctxWithProperyBinder;
