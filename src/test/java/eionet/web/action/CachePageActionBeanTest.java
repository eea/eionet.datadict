...
public class CachePageActionBeanTest {
    ...
    public void setUp() {
        ...
        ActionBeanDependencyInjectionInterceptor.dependencyInjector = new CachePageActionBeanTest.DependencyInjector(cacheService, errorPageService);
    }
