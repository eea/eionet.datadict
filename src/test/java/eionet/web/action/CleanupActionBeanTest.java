...
public class CleanupActionBeanTest {
    ...
    public void setUp() {
        ...
        ActionBeanDependencyInjectionInterceptor.dependencyInjector = new CleanupActionBeanTest.DependencyInjector(cleanupService, errorPageService);
    }
