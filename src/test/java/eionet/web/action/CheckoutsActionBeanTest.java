...
public class CheckoutsActionBeanTest {
    ...
    public void setUp() {
        ...
        ActionBeanDependencyInjectionInterceptor.dependencyInjector = new CheckoutsActionBeanTest.DependencyInjector(checkoutsService, errorPageService);
    }
